...
(0, component_1.VantComponent)({
    ...
    methods: {
        ...
        getImageInfo: function () {
            var _this = this;
            var _a = this.data, qualityWidth = _a.qualityWidth, innerAspectRadio = _a.innerAspectRadio, filePath = _a.filePath, cropperW = _a.cropperW, cropperH = _a.cropperH, cutL = _a.cutL, cutR = _a.cutR, cutT = _a.cutT, cutB = _a.cutB;
            wx.showLoading({
                title: '图片处理中...',
            });
