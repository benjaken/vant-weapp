    ...
    props: {
        ...
        value: {
            ...
            observer(value) {
                ...
                if (value !== undefined) {
                    const values = this.data.tabs.map((tab) => { var _a; return (_a = tab.selected) === null || _a === void 0 ? void 0 : _a[fieldNames.value]; });
        ...
        getSelectedOptionsByValue(options, value) {
            ...
            for (const option of options) {
                ...
                if (option[fieldNames.children]) {
                    const selectedOptions = this.getSelectedOptionsByValue(option[fieldNames.children], value);
                    if (selectedOptions) {
            ...
            if (value !== undefined) {
                ...
                if (selectedOptions) {
                    ...
                    tabs = selectedOptions.map((option) => {
                        ...
                        const next = optionsCursor.find((item) => item[fieldNames.value] === option[fieldNames.value]);
                        if (next) {
