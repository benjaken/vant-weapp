...
var stdin_default$1x = defineComponent({
  ...
  setup(props, {
    ...
    const renderNav = () => children.map((item, index) => createVNode(stdin_default$1A, mergeProps({
      "key": item.id,
      "id": `${id}-${index}`,
  ...
  setup(props, {
    ...
    const renderTipContent = () => {
      ...
      if (type === "password" && passwordTip.length > 0) {
        return passwordTip.map((item) => createVNode("div", {
        ...
        }, null), createVNode("span", null, [item.text])]));
      }
      return createVNode("span", null, [formatValue2(getModelValue(), FieldTipType || "mobile")]);
    };
    const renderTip = () => {
      const {
        type,
      ...
      if (showTip.value && type !== "textarea") {
        ...
        }, [renderTipContent(), tipUnit ? createVNode("span", {
...
var stdin_default$15 = defineComponent({
  ...
  setup(props, {
    ...
    const renderButtons = () => {
      ...
      return options.map((item, index) => createVNode("div", {
        "class": bem$X("item", {
...
var stdin_default$Q = defineComponent({
  ...
  setup(props, {
    ...
    const renderMessage = (hasTitle) => {
      ...
      return createVNode("div", {
        "class": classNames
      }, [content, theme === "input" ? createVNode("input", {
        "class": bem$H("input"),
        "placeholder": inputPlaceholder,
        "onBlur": validateInput,
        "onInput": onInput
      }, null) : "", inputError.value ? createVNode("div", {
...
var stdin_default$k = defineComponent({
  ...
  setup(props, {
    ...
    const renderRows = () => Array(+props.row).fill("").map((_, i) => createVNode(stdin_default$l, {
      "key": i,
      "round": props.round,
  ...
  setup(props, {
    ...
    const renderWatermark = () => {
      const svgInner = () => {
        ...
        }, [props.content ? createVNode("span", {
          "style": {
            color: props.textColor
          }
