    ...
    methods: {
        ...
        onEditorReady: function () {
            ...
            wx.createSelectorQuery()
                ...
                if (!context)
                    return;
                var text = _this.data.value.replace(/<[^>]+>|&[^>]+;/g, '').trim();
                _this.setData({
                    editorCtx: context,
                    editorLength: text.length
                });
                if (_this.data.value) {
                    _this.data.editorCtx.setContents({
                        html: _this.data.value
                    });
                }
                wx.pageScrollTo({
                    scrollTop: 0,
        ...
        onStatusChange: function (_a) {
            var detail = _a.detail;
            this.setData({ formats: detail });
        },
        onEditorInput: function (_a) {
            var value = _a.detail.html;
        ...
        insertImage: function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, wx.chooseImage({
                                count: 1
                            })];
                        case 1:
                            res = _a.sent();
