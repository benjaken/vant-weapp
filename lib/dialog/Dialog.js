...
var stdin_default = (0, import_vue2.defineComponent)({
  ...
  setup(props, {
    ...
    const inputValue = (0, import_vue2.ref)("");
    const inputError = (0, import_vue2.ref)(false);
    ...
    const renderMessage = (hasTitle) => {
      ...
      return (0, import_vue.createVNode)("div", {
        "class": classNames
      }, [content, theme === "input" ? (0, import_vue.createVNode)("input", {
        "class": bem("input"),
        "placeholder": inputPlaceholder,
        "onBlur": validateInput,
        "onInput": onInput
      }, null) : "", inputError.value ? (0, import_vue.createVNode)("div", {
