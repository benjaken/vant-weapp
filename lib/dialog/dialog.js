...
var Dialog = function (options) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        if (dialog) {
            dialog.setData(__assign({ callback: function (action, instance, index) {
                    action === 'confirm' || action === 'more' ? resolve(__assign(__assign({}, instance), { action: action, index: index })) : reject(instance);
                } }, options));
