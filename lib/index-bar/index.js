...
var indexList = function () {
    ...
    for (var i_1 = 0; i_1 < 26; i_1++) {
        indexList.push(String.fromCharCode(charCodeOfA + i_1));
    }
    return indexList;
};
(0, component_1.VantComponent)({
    ...
    methods: {
        ...
        getActiveAnchorIndex: function () {
            ...
            for (var i_2 = this.children.length - 1; i_2 >= 0; i_2--) {
                var preAnchorHeight = i_2 > 0 ? children[i_2 - 1].height : 0;
                var reachTop = sticky ? preAnchorHeight + stickyOffsetTop : 0;
                if (reachTop + scrollTop >= children[i_2].top) {
                    return i_2;
                }
            }
            return -1;
