...
(0, component_1.VantComponent)({
    ...
    methods: {
        ...
        adjustIndex: function (index) {
            ...
            for (var i_1 = index; i_1 < count; i_1++) {
                if (!this.isDisabled(data.options[i_1]))
                    return i_1;
            }
            for (var i_2 = index - 1; i_2 >= 0; i_2--) {
                if (!this.isDisabled(data.options[i_2]))
                    return i_2;
            }
        },
        ...
        setValue: function (value) {
            ...
            for (var i_3 = 0; i_3 < options.length; i_3++) {
                if (this.getOptionText(options[i_3]) === value) {
                    return this.setIndex(i_3);
                }
            }
