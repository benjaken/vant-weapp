...
export declare function requestAnimationFrame(cb: () => void): WechatMiniprogram.NodesRef;
...
export declare function getScrollOffset(): Promise<WechatMiniprogram.ScrollOffsetCallbackResult>;
